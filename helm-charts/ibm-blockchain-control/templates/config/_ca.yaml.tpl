...
port: {{ .Values.ca.main.service.internalPort }}
...
ca:
  ...
  keyfile: /shared/crypto-config/ordererOrganizations/{{ .Values.orderers.domain }}/ca/key.pem
  # Certificate file (default: ca-cert.pem)
  certfile: /shared/crypto-config/ordererOrganizations/{{ .Values.orderers.domain }}/ca/ca.{{ .Values.orderers.domain }}-cert.pem
  # Chain file (default: chain-cert.pem)
  #chainfile: ca-chain.pem
  chainfile: /shared/crypto-config/ordererOrganizations/{{ .Values.orderers.domain }}/ca/ca.{{ .Values.orderers.domain }}-chain.pem
...
registry:
  ...
  identities:
     - name: {{ .Values.ca.admin }}
       pass: {{ .Values.ca.password }}
       type: client
       affiliation: ""
       attrs:
...
bccsp:
    ...
    sw:
        ...
        filekeystore:
            ...
            keystore: /shared/crypto-config/ordererOrganizations/{{ .Values.orderers.domain }}/ca
...
cafiles:
  {{- range $index, $org := .Values.ca.sub_cas }}
  - /shared/cas/{{ .name | lower }}/ca.yaml
  {{- end }}